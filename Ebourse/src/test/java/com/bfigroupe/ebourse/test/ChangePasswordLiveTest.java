...
import com.bfigroupe.ebourse.spring.ConfigTest;
import com.bfigroupe.ebourse.spring.PersistenceJPAConfig;
...
public class ChangePasswordLiveTest {
    ...
    private final String URL_PREFIX = "http://localhost:8080/Ebourse";
