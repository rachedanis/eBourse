...
import com.bfigroupe.ebourse.service.UserService;
import com.bfigroupe.ebourse.spring.ServiceConfig;
...
public class UserServiceIntegrationTest {
    ...
    @Test
    public void givenDetachedUser_whenAccessingEntityAssociations_thenCorrect() throws UserAlreadyExistException {
    ...
    @Test
    public void givenDetachedUser_whenServiceLoadById_thenCorrect() throws UserAlreadyExistException {
        final User user = registerUser();
    ...
    @Test
    public void givenDetachedUser_whenServiceLoadByEmail_thenCorrect() throws UserAlreadyExistException {
        final User user = registerUser();
