...
import com.bfigroupe.ebourse.spring.*;
...
public class ChangePasswordIntegrationTest {
    ...
    public void givenNotAuthenticatedUser_whenLoggingIn_thenCorrect() {
        ...
        request.when().get("/index.html").then().assertThat().statusCode(200).and().body(containsString("home"));
    }
    ...
    public void givenNotAuthenticatedUser_whenBadPasswordLoggingIn_thenCorrect() {
        ...
        request.when().get("/index.html").then().statusCode(IsNot.not(200)).body(isEmptyOrNullString());
    }
